function webGLStart() {
    ...
    b.id = 'sierpinski-canvas';
    b.width = window.innerWidth / 1;
    b.height = window.innerHeight / 1;
    b.style.width = "100%";
    b.style.height = "100%";
    document.body.appendChild(b);
    $('body').append("<div id='controls'> <div id='slider'></div> <label for='recursionLevel'>Recursion Level</label><input type='text' id='recursionLevel' /></div></div>");
